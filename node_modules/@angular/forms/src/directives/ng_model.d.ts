...
/**
 * @whatItDoes Creates a {@link FormControl} instance from a model model and binds it
 ...
 *
 * It accepts a model model as an optional {@link Input}. If you have a one-way binding
 * to `ngModel` with `[]` syntax, changing the value of the model model in the component
 * class will set the value in the view. If you have a two-way binding with `[()]` syntax
 * (also known as 'banana-box syntax'), the value in the UI will always be synced back to
 * the model model in your class as well.
 *
 ...
 * than the model model's value on submit.
 *
